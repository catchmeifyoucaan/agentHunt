        ...
        const mockDiscoveries: Discovery[] = [
          {
            ...
            type: 'wordpress_vuln',
            details: {
              vulnerability: 'Outdated WordPress 5.8',
              severity: 'high',
              cve: 'CVE-2021-39201',
              description: 'WordPress core vulnerable to XSS',
            },
            discoveredBy: 'wordpress_specialist',
          ...
          },
          {
            ...
            details: {
              ...
              method: 'GET',
              authentication: 'none',
              description: 'Unauthenticated user enumeration endpoint',
            },
            discoveredBy: 'api_specialist',
          ...
          },
          {
            ...
            details: {
              ...
              version: '6.2.1',
              plugins: ['WooCommerce 7.8', 'Elementor 3.14'],
              theme: 'Astra',
            },
            discoveredBy: 'generic_scanner',
          ...
          },
          {
            ...
            details: {
              reason: 'Admin panel with weak credentials',
              path: '/wp-admin',
        ...
        const mockStrategies: Strategy[] = [
          {
            ...
            attemptCount: 25,
            successRate: 0.72,
            sharedBy: 'api_specialist',
            timestamp: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(),
            targetPattern: '*/search?*',
          },
          {
            id: '2',
            type: 'xss',
            ...
            attemptCount: 20,
            successRate: 0.75,
            sharedBy: 'wordpress_specialist',
            timestamp: new Date(Date.now() - 48 * 60 * 60 * 1000).toISOString(),
            targetPattern: '*/comment*',
          },
          {
            id: '3',
            type: 'auth_bypass',
          ...
          },
          {
            ...
            targetPattern: '*/upload*',
          },
        ];

        const mockMetadata: TargetMetadata[] = [
          {
            target: 'https://example.com',
