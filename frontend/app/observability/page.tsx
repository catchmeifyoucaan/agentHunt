    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Real-time observability for agent workflows, LLM calls, and security operations
          </p>
        </div>
        <div className="flex gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-md text-sm font-medium transition-colors"
          >
      ...
      <div className="bg-gradient-to-r from-orange-500/10 to-transparent border border-orange-500/20 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-sm">Phoenix LLM Observability</h3>
            <p className="text-xs text-muted-foreground mt-1">
              Full LLM tracing with prompts, completions, token usage, and costs. 
              View detailed traces for AI decisions, tool executions, and agent workflows.
            </p>
