...
async function testThreeAgent() {
  ...
  const targets = [
    { id: 't1', type: 'domain' as const, value: 'https://www.premiumdelights.byspotify.com', priority: 'high' as const },
    { id: 't2', type: 'domain' as const, value: 'https://podcastcharts.byspotify.com', priority: 'medium' as const },
  ];
