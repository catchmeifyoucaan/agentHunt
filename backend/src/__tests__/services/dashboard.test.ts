  ...
  describe('getHandoffStats', () => {
    ...
    it('should fall back to handoffs table if rich_handoffs query fails', async () => {
      ...
      (database.query as jest.Mock).mockRejectedValueOnce(
        new Error('rich_handoffs table not found')
      );
      ...
      (database.query as jest.Mock)
        ...
        .mockResolvedValueOnce({
          // byFromAgentType (handoffs)
          rows: [
            {
              from_agent_type: 'OldAgentX',
              count: '5',
              completed_count: '5',
              failed_count: '0',
        ...
        .mockResolvedValueOnce({
          // byToAgentType (handoffs)
          rows: [
            {
              to_agent_type: 'OldAgentZ',
              count: '4',
              completed_count: '4',
              failed_count: '0',
              avg_duration_seconds: '0',
